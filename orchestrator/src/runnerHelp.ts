const lines = [
  ...
  "- runner:docs-encoding blocks mojibake Markdown and non-ASCII Markdown without UTF-8 BOM.",
  ...
  "- runner:readiness:strict treats warnings as failures for important live runs.",
